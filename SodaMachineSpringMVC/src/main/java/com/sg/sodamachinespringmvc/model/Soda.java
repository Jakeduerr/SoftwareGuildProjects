 ...
 */
package com.sg.sodamachinespringmvc.model;
...
public class Soda {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 17 * hash + Objects.hashCode(this.sodaName);
        hash = 17 * hash + Objects.hashCode(this.sodaCost);
        hash = 17 * hash + this.numOfSoda;
        return hash;
    }
